...
public class FirstPersonController : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip[] m_FootstepSoundsConcrete;
    ...
    public PlayerAudioLevel audioLevel;
    ...
    private void PlayLandingSound()
    {
        ...
        audioLevel.SetAudioLevel(1.0f);
        AIDirector.GenerateSound(transform.position, 5.0f);
    }
    ...
    private void PlayFootStepAudio()
    {
        ...
        RaycastHit hit;
        Physics.Raycast(transform.position, Vector3.down, out hit, 3.0f, 1);
        ...
        if (playerCrouch.crouched)
            ...
            footstepVolume = 1.0f;
        m_AudioSource.PlayOneShot(m_AudioSource.clip, footstepVolume * volumeMultiplier);
        audioLevel.SetAudioLevel(footstepVolume * volumeMultiplier);
        AIDirector.GenerateSound(transform.position, footstepVolume * volumeMultiplier);
    }
